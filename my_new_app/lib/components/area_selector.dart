...
class AreaSelector extends StatefulWidget {
  final void Function(String province, String city) onSelected;

  const AreaSelector({Key? key, required this.onSelected}) : super(key: key);
...
class _AreaSelectorState extends State<AreaSelector> {
  ...
  Future<void> _saveSelectedArea(String province, String city) async {
    final prefs = await SharedPreferences.getInstance();
        ...
        TextButton(
          onPressed: () {
            showModalBottomSheet(
              context: context,
              builder: (context) => buildAreaSelector(context),
            );
          },
          child: Text(
  ...
  Widget buildAreaSelector(BuildContext context) {
    // 创建临时变量，初始化为当前选中值
          ...
          child: Column(
            ...
            children: [
              DropdownButton<String>(
                ...
                isExpanded: true,
                items: provinceCityMap.keys.map((String province) {
              ...
              if (tempProvince != null)
                DropdownButton<String>(
                  ...
                  isExpanded: true,
                  items: provinceCityMap[tempProvince]!
              ...
              ElevatedButton(
                onPressed: tempProvince != null && tempCity != null
                    ? () {
                        ...
                        Future.microtask(() => _saveSelectedArea(
                            selectedProvince!, selectedCity!));
                        widget.onSelected(selectedProvince!, selectedCity!);
