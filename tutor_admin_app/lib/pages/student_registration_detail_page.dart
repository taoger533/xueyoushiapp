...
/// 学生登记信息详情编辑页
class StudentRegistrationDetailPage extends StatefulWidget {
  final String recordId;

  const StudentRegistrationDetailPage({super.key, required this.recordId});

  @override
  State<StudentRegistrationDetailPage> createState() => _StudentRegistrationDetailPageState();
}

class _StudentRegistrationDetailPageState extends State<StudentRegistrationDetailPage> {
  bool isLoading = true;
  ...
  Future<void> _loadRecord() async {
    ...
    try {
      final url = Uri.parse('$apiBase/api/admin/student-registration/${widget.recordId}');
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: const Text('学生登记信息详情')),
      body: isLoading
